...
Local $iEdit,$i1,$j1,$i2,$j2,$Edit1,$Edit2,$t1,$m1,$t2,$m2,$iEdit1
...
$Edit1 = GUICtrlCreateEdit("I love u u", 24, 216, 313, 89)
;GUICtrlSetData(-1, "Im at ro ub le dm an Ch an ge db yt he th in gs Id ot He ya ll re me mb er yo u")
GUICtrlSetData(-1, "I love u u")
$Edit2 = GUICtrlCreateEdit("", 24, 344, 313, 89)
...
; удалим все пробелы
$Edit1 = StringStripWS ( GUICtrlRead($Edit1), 8 )
...
;MsgBox(0, "Tutorial",$Array[0][0])
; удалим все пробелы
$Edit2 = StringStripWS ( GUICtrlRead($Edit2), 8 )
; I WILL MAKE X THE ERROR
Local $i,$j
...
Switch $nMsg
   ...
   Case $Encrypt
	  ...
	  Encrypt()
	  GUICtrlSetData($Edit2, $iEdit)
   Case $Decrypt
	  MsgBox(0, "Tutorial", "Decrypt")
	  Decrypt()
	  GUICtrlSetData($Edit1, $iEdit1)
