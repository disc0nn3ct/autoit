...
$Input111 = GUICtrlCreateInput("x", 80, 26, 73, 21)
$Label2 = GUICtrlCreateLabel("For dobble", 16, 24, 60, 25)
$Input26 = GUICtrlCreateInput("x", 232, 24, 81, 21)
$Label3 = GUICtrlCreateLabel("if without pair", 168, 24, 52, 25)


$Radio1 = GUICtrlCreateRadio("1-st", 32, 0, 49, 17)
$Radio2 = GUICtrlCreateRadio("2-end", 88, 0, 65, 17)
...
$Edit1 = $Edit1 & GUICtrlRead($Input26)
...
$f = GUICtrlRead($Input111)
Else
$s = GUICtrlRead($Input111)
EndIf
...
Switch $nMsg
  ...
  ; Case $nMsg = $Radio1 And BitAND(GUICtrlRead($iRadio1), $GUI_CHECKED) = $GUI_CHECKED

  ; GUICtrlRead($iRadio1), $GUI_CHECKED)
